...
validation performance and stop the algorithm when the validation performance
metrics no longer improve. In the limit of large number of examples, program
"svmasgd" should reach this point after one or two epochs only.
...
$ make clean && make OPT=-DLOSS=HingeLoss
....
$ ./svmsgd -lambda 1e-4 rcv1.train.bin.gz rcv1.





Here is a transcriptThe preprocessing program "prep_rcv1" produces two data files:

"rcv1.train.bin.gz"
  Compressed training data in compressed binary format.
  There are 781265 training documents, 370541 positives and 410724 negatives.
  The examples in this file are randomly shuffled.

"rcv1.test.bin.gz"
  Compressed testing data in both binary and svmlight formats.
  There are 23149 testing documents, 10786 positives and 12363 negatives.
